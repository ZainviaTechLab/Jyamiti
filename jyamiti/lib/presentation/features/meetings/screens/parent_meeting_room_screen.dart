...
class _ParentMeetingRoomScreenState extends State<ParentMeetingRoomScreen> {
  ...
  Future<void> _handleNoShowTimeout() async {
    ...
    await showDialog<void>(
      ...
      // bug, see the End/Leave confirmation dialog below for the full
      // explanation).
...
<body>
  ...
  Future<void> _handleEndOrLeaveCall() async {
    ...
    // renders fine but every tap on it -- including its own End Meeting/
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              // in PointerInterceptor so its buttons (End Meeting/Leave
