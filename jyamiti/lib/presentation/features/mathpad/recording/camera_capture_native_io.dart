// Renamed from camera_capture_native.dart -- imported conditionally now
// (see camera_capture_native.dart, the new barrel file) rather than
// directly, because dart:ffi and package:ffi (used throughout this file
// for the Windows/Linux native bridges) don't compile for web at all
// ("Only JS interop members may be 'external'", the same restriction that
// motivated extracting job_object_lifetime_io.dart out of
// mathpad_recording_service.dart). camera_capture_native_web.dart is the
// web-safe stub with matching class shapes.
